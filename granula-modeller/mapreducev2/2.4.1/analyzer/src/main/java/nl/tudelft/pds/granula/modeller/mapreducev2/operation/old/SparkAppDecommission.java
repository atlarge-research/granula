...
public class SparkAppDecommission extends AbstractOperationModel {

    public SparkAppDecommission() {
        super(MapReduceV2Type.SparkApplication, MapReduceV2Type.Decommission);
    }
