...
public class SparkJobSparkJob extends ConcreteOperationModel {
    ...
    public SparkJobSparkJob() {
        super(MapReduceV2Type.SparkJob, MapReduceV2Type.SparkJob);
    }
    ...
    public class SparkJobParentLinking extends LinkingRule {
        ...
        public boolean execute() {
            ...
            for (Operation candidateOperation : operation.getJob().getMemberOperations()) {
                ...
                if(candidateOperation.hasType(MapReduceV2Type.Coordinator, MapReduceV2Type.Setup)) {
                    matchedApps.add(candidateOperation);
                } else if(candidateOperation.hasType(MapReduceV2Type.Coordinator, MapReduceV2Type.Superstep)) {
                    matchedApps.add(candidateOperation);
                } else if(candidateOperation.hasType(MapReduceV2Type.Coordinator, MapReduceV2Type.Cleanup)) {
                    cleanup = candidateOperation;
                } else if(candidateOperation.hasType(MapReduceV2Type.SparkContext, MapReduceV2Type.SparkContext)) {
