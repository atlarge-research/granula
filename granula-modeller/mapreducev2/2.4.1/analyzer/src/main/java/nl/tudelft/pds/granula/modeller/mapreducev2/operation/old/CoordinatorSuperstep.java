...
public class CoordinatorSuperstep extends ConcreteOperationModel {
    ...
    public CoordinatorSuperstep() {
        super(MapReduceV2Type.Coordinator, MapReduceV2Type.Superstep);
    }

    public void loadRules() {
        super.loadRules();

        addLinkingRule(new UniqueParentLinking(MapReduceV2Type.Coordinator, MapReduceV2Type.BspIteration));
        addFillingRule(new UniqueIdOperationFilling(1, MapReduceV2Type.MsgReceiver, MapReduceV2Type.MsgReceive));
        addFillingRule(new UniqueIdOperationFilling(1, MapReduceV2Type.GraphConstructor, MapReduceV2Type.GraphConstruct));
        addFillingRule(new UniqueIdOperationFilling(1, MapReduceV2Type.GraphUpdater, MapReduceV2Type.GraphUpdate));
        addFillingRule(new UniqueIdOperationFilling(1, MapReduceV2Type.MsgSender, MapReduceV2Type.MsgSend));
        addFillingRule(new UniqueIdOperationFilling(1, MapReduceV2Type.MsgCounter, MapReduceV2Type.MsgCount));
