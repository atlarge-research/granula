...
public class MapperMapTask extends IncompleteConcreteOperationModel {

    public MapperMapTask() {
        super(MapReduceV2Type.Mapper, MapReduceV2Type.MapTask);
    }
...
//        addInfoDerivation(new DurationDerivation(3));
        ...
        addInfoDerivation(new ShortenMapperIdDerivation(4));
//        addInfoDerivation(new RecordInfoDerivation(1, "InputSplit"));
...
//                    add("ShuffleWrite");
    ...
    protected class ShortenMapperIdDerivation extends DerivationRule {

        public ShortenMapperIdDerivation(int level) { super(level); }
