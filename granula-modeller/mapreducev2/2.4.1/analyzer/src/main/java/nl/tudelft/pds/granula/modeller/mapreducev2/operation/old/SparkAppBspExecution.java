...
public class SparkAppBspExecution extends AbstractOperationModel {
    ...
    public SparkAppBspExecution() {
        super(MapReduceV2Type.SparkApplication, MapReduceV2Type.Execution);
    }
    ...
    public void loadRules() {
        ...
        addFillingRule(new UniqueOperationFilling(3, MapReduceV2Type.Coordinator, MapReduceV2Type.BspIteration));
        addFillingRule(new UniqueOperationFilling(3, MapReduceV2Type.Coordinator, MapReduceV2Type.Processing));

        addInfoDerivation(new SummaryDerivation(10));
        addInfoDerivation(new SiblingStartTimeDerivation(
                3, MapReduceV2Type.SparkApplication, MapReduceV2Type.Deployment));
        addInfoDerivation(new SiblingEndTimeDerivation(
                3, MapReduceV2Type.SparkApplication, MapReduceV2Type.Decommission));
