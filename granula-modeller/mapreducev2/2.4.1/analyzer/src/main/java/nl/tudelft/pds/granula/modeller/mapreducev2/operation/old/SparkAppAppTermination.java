...
public class SparkAppAppTermination extends ConcreteOperationModel {

    public SparkAppAppTermination() {
        super(MapReduceV2Type.SparkApplication, MapReduceV2Type.AppTermination);
    }

    public void loadRules() {
        super.loadRules();

        addLinkingRule(new UniqueParentLinking(MapReduceV2Type.SparkApplication, MapReduceV2Type.Decommission));
