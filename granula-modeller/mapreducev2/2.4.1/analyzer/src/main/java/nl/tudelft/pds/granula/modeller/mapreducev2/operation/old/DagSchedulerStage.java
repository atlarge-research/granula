...
public class DagSchedulerStage extends ConcreteOperationModel {
    ...
    public DagSchedulerStage() {
        super(MapReduceV2Type.DagScheduler, MapReduceV2Type.Stage);
    }
    ...
    public void loadRules() {
        ...
        addInfoDerivation(new FilialLongAggregationDerivation(2, MapReduceV2Type.Task, "RunTime"));
        addInfoDerivation(new FilialLongAggregationDerivation(2, MapReduceV2Type.Task, "InputSize"));
        addInfoDerivation(new FilialAggStringDerivation(2, MapReduceV2Type.Task, "InputMethod"));
        addInfoDerivation(new FilialLongAggregationDerivation(2, MapReduceV2Type.Task, "ShuffleRead"));
        addInfoDerivation(new FilialLongAggregationDerivation(2, MapReduceV2Type.Task, "ShuffleWrite"));
