...
public class CoordinatorBspIteration extends AbstractOperationModel {
    ...
    public CoordinatorBspIteration() {
        super(MapReduceV2Type.Coordinator, MapReduceV2Type.BspIteration);
    }

    public void loadRules() {
        super.loadRules();

        addLinkingRule(new UniqueParentLinking(MapReduceV2Type.SparkApplication, MapReduceV2Type.Execution));
        addLinkingRule(new RemoveIfEmptyLinking(2));

        addInfoDerivation(new FilialLongAggregationDerivation(4, MapReduceV2Type.Superstep, "MessageCount", "MessageCount"));
        addInfoDerivation(new FilialTimeSeriesDerivation(5, "TS-MessageCount", MapReduceV2Type.Superstep, "MessageCount"));
