...
public class JobEndTimeDerivation extends DerivationRule {

    public JobEndTimeDerivation(int level) {
        super(level);
    }
    ...
    public boolean execute() {
        ...
        long endtime = entity.getJob().getOverview().getEndTime();
        info.setDescription("The [EndTime] of an operation is retrieved from the Job EndTime.");
