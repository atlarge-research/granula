...
import science.atlarge.granula.modeller.platform.visual.SummaryVisual;
import science.atlarge.granula.modeller.platform.info.Info;

public class SummaryVisualization extends VisualizationRule {

    public SummaryVisualization(int level) { super(level); }
