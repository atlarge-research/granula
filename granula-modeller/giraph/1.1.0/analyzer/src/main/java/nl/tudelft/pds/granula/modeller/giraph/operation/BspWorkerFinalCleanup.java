...
public class BspWorkerFinalCleanup extends ConcreteOperationModel {

    public BspWorkerFinalCleanup() {
        super(GiraphType.BspWorker, GiraphType.FinalCleanup);
    }
    ...
    protected class SummaryDerivation extends BasicSummaryDerivation {
        ...
        public boolean execute() {
            ...
            String summary = String.format("The [%s] operation is executed by each BspWorker before termination. " +
                            "which contains 2 child operations: %s and/or %s. ", "ZookeeperOfflining", "OutputMerge", operation.getName());
