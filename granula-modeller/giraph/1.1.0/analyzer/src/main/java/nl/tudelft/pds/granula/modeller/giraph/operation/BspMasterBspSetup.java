...
public class BspMasterBspSetup extends AbstractOperationModel {

    public BspMasterBspSetup() {
        super(GiraphType.BspMaster, GiraphType.BspSetup);
    }

    public void loadRules() {
        super.loadRules();

        addFillingRule(new UniqueOperationFilling(4, GiraphType.GlobalCoordinator, GiraphType.GlobalStartup));
