...
public class    AppMasterAppTermination extends ConcreteOperationModel {

    public AppMasterAppTermination() {
        super(GiraphType.AppMaster, GiraphType.AppTermination);
    }
    ...
    protected class SummaryDerivation extends BasicSummaryDerivation {
        ...
        public boolean execute() {
            ...
            String summary = String.format("The [%s] operation awaits the termination of the %s. ",
                    operation.getName(), "AppMaster");
