...
public class BspWorkerZookeeperCleanup extends ConcreteOperationModel {

    public BspWorkerZookeeperCleanup() {
        super(GiraphType.BspWorker, GiraphType.ZookeeperCleanup);
    }
