...
public class BspWorkerDataload extends ConcreteOperationModel {

    public BspWorkerDataload() {
        super(GiraphType.BspWorker, GiraphType.DataLoad);
    }

    public void loadRules() {
        super.loadRules();
        addLinkingRule(new UniqueParentLinking(GiraphType.GlobalCoordinator, GiraphType.GlobalDataload));
        addInfoDerivation(new ColorDerivation(1, GiraphType.ColorBlue));
//        addInfoDerivation(new RecordInfoDerivation(1, "AllReceivedReqs"));
        addInfoDerivation(new RecordInfoDerivation(1, "LoadedEdgeCount"));
        addInfoDerivation(new RecordInfoDerivation(1, "LoadedVertexCount"));
        addInfoDerivation(new RecordInfoDerivation(1, "ComputeNode"));
        addInfoDerivation(new RecordInfoDerivation(1, "LoadedDataVolume"));
