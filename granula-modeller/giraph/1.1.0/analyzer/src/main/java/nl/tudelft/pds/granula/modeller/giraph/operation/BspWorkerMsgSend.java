...
public class BspWorkerMsgSend extends ConcreteOperationModel {

    public BspWorkerMsgSend() {
        super(GiraphType.BspWorker, GiraphType.MsgSend);
    }
...
//                    add("SentMsgs");
    ...
    protected class SummaryDerivation extends BasicSummaryDerivation {
        ...
        public boolean execute() {
            ...
            String summary = String.format("The [%s] operation waits for network requests to be finished, " +
                            "which is depending on the responsiveness of the other BspWorkers. ",
                    operation.getName());
