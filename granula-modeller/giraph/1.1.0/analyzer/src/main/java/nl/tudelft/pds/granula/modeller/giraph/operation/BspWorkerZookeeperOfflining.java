...
public class BspWorkerZookeeperOfflining extends ConcreteOperationModel {

    public BspWorkerZookeeperOfflining() {
        super(GiraphType.BspWorker, GiraphType.ZookeeperOfflining);
    }

    public void loadRules() {
        super.loadRules();
        addLinkingRule(new IdentifierParentLinking(GiraphType.BspWorker, GiraphType.Equal, GiraphType.FinalCleanup , GiraphType.Unique));
    ...
    protected class SummaryDerivation extends BasicSummaryDerivation {
        ...
        public boolean execute() {
            ...
            String summary = String.format("The [%s] operation makes Zookeeper offline. " +
                    "The exact purpose of this operation is yet unclear. ", operation.getName());
