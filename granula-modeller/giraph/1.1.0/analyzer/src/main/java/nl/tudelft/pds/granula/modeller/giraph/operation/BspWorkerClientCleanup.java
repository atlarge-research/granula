...
public class BspWorkerClientCleanup extends ConcreteOperationModel {

    public BspWorkerClientCleanup() {
        super(GiraphType.BspWorker, GiraphType.ClientCleanup);
    }
    ...
    protected class SummaryDerivation extends BasicSummaryDerivation {
        ...
        public boolean execute() {
            ...
            String summary = String.format("The [%s] operation cleans up the (Netty) Client in each BspWorker. " +
