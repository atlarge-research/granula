...
public class BspWorkerOutputMerge extends ConcreteOperationModel {

    public BspWorkerOutputMerge() {
        super(GiraphType.BspWorker, GiraphType.OutputMerge);
    }
    ...
    protected class SummaryDerivation extends BasicSummaryDerivation {
        ...
        public boolean execute() {
            ...
            String summary = String.format("The [%s] operation merges the data output from each BspWorker together in HDFS as a single file. ",
                    operation.getName());
