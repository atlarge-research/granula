...
public class BspWorkerServerCleanup extends ConcreteOperationModel {

    public BspWorkerServerCleanup() {
        super(GiraphType.BspWorker, GiraphType.ServerCleanup);
    }
    ...
    protected class SummaryDerivation extends BasicSummaryDerivation {
        ...
        public boolean execute() {
            ...
            String summary = String.format("The [%s] operation cleans up the (Netty) Server in each BspWorker. " +
