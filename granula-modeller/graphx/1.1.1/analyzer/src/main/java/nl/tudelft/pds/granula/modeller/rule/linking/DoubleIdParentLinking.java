...
public class DoubleIdParentLinking extends LinkingRule {
    ...
    public DoubleIdParentLinking(String parentActorType, String parentActorId,
        ...
        for (Operation candidateOperation : operation.getJob().getMemberOperations()) {
            ...
            if(parentActorId.equals(Identifier.Unique)) {
                ...
                if(operation.hasRecord(parentActorId)) {
                    String matchedParentActorId = String.valueOf((int) Double.parseDouble(operation.getRecord(parentActorId).getAttr("InfoValue")));
            ...
            if(parentMissionId.equals(Identifier.Unique)) {
                ...
                if(operation.hasRecord(parentMissionId)) {
                    String matchedParentMissionId = String.valueOf((int) Double.parseDouble(operation.getRecord(parentMissionId).getAttr("InfoValue")));
