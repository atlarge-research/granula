...
//        notifier.playMilestone();
        ...
        workloadFile = new File("/home/wing/Workstation/Dropbox/Projects/Result/log/graphx.tar.gz");
        ...
        RecordManager recordManager = new GraphXRecordManager(workloadLog);
