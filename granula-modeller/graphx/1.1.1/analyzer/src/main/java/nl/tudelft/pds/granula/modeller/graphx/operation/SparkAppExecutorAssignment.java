...
public class SparkAppExecutorAssignment extends ConcreteOperationModel {

    public SparkAppExecutorAssignment() {
        super(GraphXType.SparkApplication, GraphXType.ExecutorAssignment);
    }

    public void loadRules() {
        super.loadRules();

        addLinkingRule(new UniqueParentLinking(GraphXType.SparkApplication, GraphXType.Deployment));

        addInfoDerivation(new SummaryDerivation(10));
        addInfoDerivation(new RecordInfoDerivation(1, "ExecutorSize"));
