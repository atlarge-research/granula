...
public class GraphConstructorGraphConstruct extends AbstractOperationModel {

    public GraphConstructorGraphConstruct() {
        super(GraphXType.GraphConstructor, GraphXType.GraphConstruct);
    }

    public void loadRules() {
        super.loadRules();

        addLinkingRule(new IdentifierParentLinking(GraphXType.Coordinator, Identifier.Unique,
                GraphXType.Superstep, Identifier.Equal));
