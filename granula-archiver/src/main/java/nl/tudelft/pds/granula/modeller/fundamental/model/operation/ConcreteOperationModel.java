...
import nl.tudelft.pds.granula.modeller.fundamental.rule.derivation.UuidOperationDerivation;
import nl.tudelft.pds.granula.modeller.fundamental.rule.derivation.time.EndTimeDerivation;
import nl.tudelft.pds.granula.modeller.fundamental.rule.derivation.time.StartTimeDerivation;
import nl.tudelft.pds.granula.modeller.fundamental.rule.derivation.time.DurationDerivation;
public class ConcreteOperationModel extends OperationModel {

    public ConcreteOperationModel(String actorType, String missionType) {
    ...
    public void loadRules() {
        ...
        addInfoDerivation(new EndTimeDerivation(1));
