...
public class DescendantLongAggregationDerivation extends DerivationRule {
    ...
    public DescendantLongAggregationDerivation(int level, String missionType, int searchLevel, String infoName, String aggInfoName) {
        super(level);
    ...
    public DescendantLongAggregationDerivation(int level, String missionType, int searchLevel, String infoName) {
        super(level);
        this.missionType = missionType;
        this.infoName = infoName;
