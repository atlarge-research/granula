...
package nl.tudelft.pds.granula.modeller.fundamental.rule.visual;
...
public class MainInfoTableVisualization extends VisualizationRule {

    List<String> keyInfoNames;
    public MainInfoTableVisualization(int level, List<String> keyInfoNames) {
        super(level);
    ...
    public boolean execute() {
        ...
        TableVisual tableVisual = new TableVisual("MainInfoVisual");
