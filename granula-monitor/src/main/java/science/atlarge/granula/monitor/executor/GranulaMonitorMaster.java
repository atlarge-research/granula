...
public class GranulaMonitorMaster {
...
//        startMonitorWorker();
    ...
    public static void startMonitorMaster() {
        MonitorMaster monitorMaster = new MonitorMaster();
        monitorMaster.setConf(Paths.get("conf/profiler-master.conf"));
        monitorMaster.init();
    }


    public static void startMonitorWorker() {
