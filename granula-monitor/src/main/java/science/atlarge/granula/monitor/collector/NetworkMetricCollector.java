...
public class NetworkMetricCollector extends ProcFSCollector {
    ...
    private void setMetricStores() {
        netEthSndStore = setMetricStore("net-eth-snd");
        netEthRecStore = setMetricStore("net-eth-rec");
...
//
//
        netEthRecStore.addMeasurement(new Measurment(timestamp, String.valueOf(remoteReceiveVolume)));
        netEthSndStore.addMeasurement(new Measurment(timestamp, String.valueOf(remoteTransmitVolume)));
//
//
